let { Chunks } = require('laravel-mix/src/Chunks');
let buildConfig = require('laravel-mix/src/config');
let ComponentRegistrar = require('laravel-mix/src/components/ComponentRegistrar');
let Components = require('laravel-mix/src/components/Components');
let Dependencies = require('laravel-mix/src/Dependencies');
let Dispatcher = require('laravel-mix/src/Dispatcher');
let Dotenv = require('dotenv');
let File = require('laravel-mix/src/File');
let HotReloading = require('laravel-mix/src/HotReloading');
let Manifest = require('laravel-mix/src/Manifest');
let Paths = require('laravel-mix/src/Paths');
let WebpackConfig = require('laravel-mix/src/builder/WebpackConfig');
let { Resolver } = require('laravel-mix/src/Resolver');
const Log = require('laravel-mix/src/Log');

/** @typedef {import("laravel-mix/src/tasks/Task")} Task */
...
class Mix {
     ...
     * @param {import('laravel-mix/src/Dispatcher').Handler} callback
     */
