...
let Entry = require('laravel-mix/src/builder/Entry.js');
let webpackRules = require('laravel-mix/src/builder/webpack-rules.js');
let webpackPlugins = require('laravel-mix/src/builder/webpack-plugins.js');
let webpackDefaultConfig = require('laravel-mix/src/builder/webpack-default.js');

class WebpackConfig {
    /**
     * Create a new instance.
     *
     * @param {import("laravel-mix/src/Mix.js")} mix
     */
    constructor(mix) {
        this.mix = mix;
     ...
     */
    buildChunks() {
        this.webpackConfig = require('laravel-mix/src/builder/MergeWebpackConfig.js')(
            this.webpackConfig,
