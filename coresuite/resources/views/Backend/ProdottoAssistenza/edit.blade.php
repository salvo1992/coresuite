...
<div class="row">
      <div class="col-md-6">
@include('Backend._inputs.inputColor',['campo'=>'colore_hex','testo'=>'Colore hex','required'=>true])
       </div>
</div>
<div class="row">
      <div class="col-md-6">
@include('Backend._inputs.inputSwitch',['campo'=>'attivo','testo'=>'Attivo',])
                ...
                <div class="row">
                    <div class="col-md-4 offset-md-4 text-center">
                        <button class="btn btn-primary mt-3" type="submit" id="submit">{{$vecchio?'Salva modifiche':'Crea '.\App\Models\ProdottoAssistenza::NOME_SINGOLARE}}</button>
                    </div>
                    @if($vecchio)
