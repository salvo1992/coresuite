...
return [
    ...
    */
    ...
    'remote_sites_path' => env('IGNITION_REMOTE_SITES_PATH', '/home/vagrant/code/consulenzadiritto' ),
    'local_sites_path' => env('IGNITION_LOCAL_SITES_PATH', '/Users/andrea/Documents/homestead/consulenzadiritto' ),
    /*
    |--------------------------------------------------------------------------
