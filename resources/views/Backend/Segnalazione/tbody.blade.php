@foreach($records as $record)
    <tr class="" id="tr_{{$record->id}}">
        <td class="">{{$record->nome_azienda}}</td>
        <td class="">{{$record->partita_iva}}</td>
        <td class="">{{$record->indirizzo}}</td>
        <td class="">{{$record->citta}}</td>
        <td class="">
            @if($record->agente_id)
        ...
        <td class="text-end text-nowrap">
            @if($puoCambiareStato)
                <a href="{{action([\App\Http\Controllers\Backend\ModalController::class,'show'],['modifica-stato-segnalazione',$record->id])}}"
