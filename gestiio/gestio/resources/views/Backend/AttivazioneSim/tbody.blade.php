@foreach($records as $record)
    <tr class="" id="tr_{{$record->id}}">
        ...
        <td class="d-none d-md-table-cell">
            {!! \App\telefonoWhatsapp($record->cellulare) !!}<br>
            {{$record->email}}
        </td>
        ...
        <td class="text-end text-nowrap">
            <div class="btn-group" role="group">
                ...
                @if($record->allegati_count)
                    <a href="{{action([\App\Http\Controllers\Backend\ModalController::class,'show'],['modal-allegati-attivazione',$record->id])}}"
                ...
                <a href="{{action([\App\Http\Controllers\Backend\ModalController::class,'show'],['sostituzione-sim',$record->id])}}"
                   class="btn btn-icon btn-sm btn-light btn-active-light-primary"
                   data-target="kt_modal" data-toggle="modal-ajax"
                   data-bs-toggle="tooltip" data-bs-placement="top" title="Sostituzione sim"
                >
                ...
                @if($record->esito_id!='bozza')
                    @if($puoModificare)
                        <a href="{{action([\App\Http\Controllers\Backend\ModalController::class,'show'],['modifica-stato-attivazione',$record->id])}}"
                           class="btn btn-icon btn-sm btn-light btn-active-light-primary"
                           data-target="kt_modal" data-toggle="modal-ajax"
