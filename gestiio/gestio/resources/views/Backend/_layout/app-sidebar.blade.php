...
<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}"
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        ...
        <a href="/">
            ...
            <img alt="Logo" src="/loghi/g_white.png" class="h-20px h-lg-30px app-sidebar-logo-minimize theme-light-show">
            <img alt="Logo" src="/loghi/g_white.png" class="h-20px h-lg-30px app-sidebar-logo-minimize theme-dark-show">
        </a>
