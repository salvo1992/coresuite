                ...
                <tr>
                    <td align="center" valign="top">
                        <h3 style="height: 40px; line-height: 40px; background-color: #f56857; color: #ffffff;">There
                            has been an exception thrown on {{ env('APP_NAME', 'unknown') }}</h3>
                        ...
                        <table align="center" style="text-align: center;" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                                    In <a href="{{$phpStormLink}}"> {{ $exception->getFile() }} on line {{  $exception->getLine() }}</a>
                                </td>
                            </tr>
                        </table>
                        <hr style="color: #f6f6f6;">
