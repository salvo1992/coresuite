...
<div class="row">
    <div class="col-md-6">
        @include('Backend._inputs.inputTextReadonly',['campo'=>'profilo','testo'=>'Profilo','required'=>true,'array'=>\App\Models\ProdottoSkyTv::PROFILO])
    </div>
    <div class="col-md-6">
        @include('Backend._inputs.inputTextReadonly',['campo'=>'codice_promozione','testo'=>'Codice promozione','autocomplete'=>'off'])
    </div>
</div>
<div class="row">
    <div class="col-md-6">
...
@if($record->metodo_pagamento_tv=='carta_credito')
    <div id="div_carta">
