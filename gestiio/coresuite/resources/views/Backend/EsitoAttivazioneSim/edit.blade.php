    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="POST" action="{{action([$controller,'update'],$record->id??'')}}">
                ...
                <div class="row">
                    <div class="col-md-6">
                        @include('Backend._inputs.inputSwitch',['campo'=>'notifica_mail','testo'=>'Notifica mail ad agente',])
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-4 offset-md-4 text-center">
                        <button class="btn btn-primary mt-3" type="submit" id="submit">{{$vecchio?'Salva modifiche':'Crea '.\App\Models\EsitoAttivazioneSim::NOME_SINGOLARE}}</button>
                    </div>
                    @if($vecchio)
